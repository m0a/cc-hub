...
export const TerminalComponent = memo(forwardRef<TerminalRef, TerminalProps>(function TerminalComponent({
  ...
  useEffect(() => {
    ...
    // On desktop, allow native right-click menu for copy/paste
    const handleContextMenu = (e: Event) => {
      if (!hideKeyboardRef.current) {
        // Mobile/tablet: prevent context menu (long press handled separately)
        e.preventDefault();
      }
      // Desktop (hideKeyboard=true): allow native context menu
    };
