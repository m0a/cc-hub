...
export const TERMINAL_THEMES_DARK: Record<SessionTheme | 'default', { background: string; foreground: string; accent: string }> = {
...
export const TERMINAL_THEMES_LIGHT: Record<SessionTheme | 'default', { background: string; foreground: string; accent: string }> = {
